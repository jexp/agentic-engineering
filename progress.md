...
- `workshop-exercise-2.md` — 60-min main exercise brief: 4 task archetypes (nasty bug, new feature, MCP on your product surface, cross-language port), explicit 0:00–1:00 minute breakdown, AGENTS.md starter template, 5 execution rules, success metrics, facilitator notes, anti-patterns
...
- 2026-05-26: Integrated Karpathy's four task-level behavioral rules (think before coding / simplicity first / surgical changes / goal-driven) into workshop-practices.md (new "Task-level behavioral instructions" subsection in Slide 4, AGENTS.md section; expanded Karpathy callout in Optional callouts; sources added) and keynote vibecode-keynote-v4-notes.md (Slide 18 speaker notes — sixth layer / forward-looking harness note). Key framing: these rules steer per-task agent behavior, must be encoded explicitly in AGENTS.md today, and are strong candidates to become harness defaults within 12 months.
...
- 2026-05-18: Created `keynote/vibecode-keynote-v4-draft.md` — full 40-min keynote draft (42 slides + demo narration). 6 acts: audience engagement → O'Reilly cover demo → history (4 phases) → "where does the rigor go?" (5 TW destinations) → hone-ai spec-driven demo → future (middle loop, agent topologies, cognitive debt, reversibility) → human-in-the-loop (Claire Vo management skills, exhaustion, what stays human) → close. Integrates V1+V3 narrative, workshop slides content, Simon new material, TW retreat, hone-ai diagram, O'Reilly running theme.
- 2026-05-18: Created `research/thoughtworks-retreat.md` — full mining of Thoughtworks Feb 2026 Future of Software Engineering retreat (Deer Valley, Chatham House Rule). 10 major themes: "where does the rigor go?" (5 destinations), the Middle Loop (new unnamed supervisory engineering category), agent topologies + Conway's Law, productivity/experience paradox, cognitive debt, AI velocity debt / batch-size regression, juniors more valuable / mid-levels at risk, semantic layers, agentic OS, security dangerously behind. Per-section reuse mapping included.
- 2026-05-18: Updated `research/simon-mining.md` — added Simon's Agentic Engineering Patterns guide (simonwillison.net/guides/agentic-engineering-patterns/) as canonical resource; added 5 new May 2026 articles: Heavybit/vibe-AE convergence, GitLab Act 2, James Shore maintenance-cost math, Mitchell Hashimoto reversibility pattern, Shopify Lehrwerkstatt / public-channel agent learning. TL;DR now 16 items.
- 2026-05-11: Added Simon Willison's Heavybit High Leverage Ep. 9 (with Joseph Ruscio) to `research/simon-mining.md`. New content: vibe-coding/AE convergence admission ("disturbing realization"), the team/black-box trust analogy, "normalization of deviance" coinage, the new software evaluation challenge ("I want somebody to have used the thing"), shifted SDLC bottleneck insight, Jenny Wen (Anthropic design lead) on design-process risk, Matthew Yglesias quote on professionally-managed software. Added to TL;DR, per-section table, quote bank, and open questions.
- 2026-05-11: Added Max Schoening (Notion Head of Product) observations from Lenny's Podcast to `workshop/agentic-engineering-ideas.md`. Themes covered: vibe coding quality skepticism + 3D printing analogy; agency as the new differentiator over skills; build-vs-buy / maintenance realism (SaaS apocalypse is exaggerated); malleable software framing; token spend as vanity metric; playground onboarding approach for non-engineers; retina display / intelligence saturation analogy.
...
- 2026-05-18: **Major keynote v4 update** — 4 parallel background agents completed. New files: `research/gitlab-act2.md`, `research/rewrites.md`, `research/pair-programming-ralphing.md`, `research/verify-report.md`, `blog/blog-series-outline.md`. Keynote v4 updated with ~10 new/expanded slides: Act III "practices for the maintainer" opener; expanded specs/waterfall slide; "Ship a spec, not code" (Ryan Lopopolo/OpenAI Frontier); navigator/driver pair programming (Kent Beck anchor); Ladybird + chardet two-slide reversibility section; GitLab Act 2 org restructure; expanded exhaustion with addiction pattern; Lehrwerkstatt/River learning slide. Blog series: 12-post outline with full content notes written. All 12 URL verifications completed (11/12 confirmed; Lenny's "building is cheap" quote may be paywalled — use Lenny's highlights post instead).

- 2026-05-18: **Keynote v4 review + edits applied** — created `keynote/review-v4.md` (critical review: timing, 9 cut candidates, 3 merges, 6 compressions, 4 missing pieces, structural issues). User updated review to 4 cuts. Applied all changes to `vibecode-keynote-v4-notes.md`: 4 cuts (Slides 14, 27, 31, 43), 3 merges (18+19, 26+26b, 41+42), 6 compressions (5b, 27/task-boundaries, 35/reversibility, 36/chardet, 38/GitLab, 46/Monday), 1 new slide (Ralphing, Slide 28). Act V renamed "Where It's Already Going". Clean integer renumbering: 48 slides. Verifications: Claire Vo "20 years plus" confirmed; 275M commits source confirmed (Kyle Daigle/Forbes); Bill Staples quote confirmed; arXiv 2603.15021 + 2510.22787 confirmed; Yglesias sourced via simonwillison.net/2026/Apr/28/matthew-yglesias/.

## Next up (suggested order)

1. **Keynote**: read-aloud timing pass with stopwatch — 48 slides + 12 min demo, targeting 40 min.
3. **Blog 1 draft** — "What Is Agentic Engineering?" (C20) — outline is in blog/blog-series-outline.md.
4. **Workshop review** (workshop is tomorrow): review workshop-outline.md pre-flight checklist; confirm Exercise 1 and 2 starter options.
5. **James Shore maintenance reframe** (B140): one-line addition to keynote Slide 22 (risk tiering notes).
6. Review all 5 workshop docs (intro, harnesses, practices, resources, own-experience) → tighten quotes, decide cuts for time-box.
7. Pick the *one* artifact to demo per own-experience slide (TODO listed in that doc).
8. Confirm mongot analysis is OK to show publicly (otherwise swap to claude-code analysis as the only Slide 3 demo).
